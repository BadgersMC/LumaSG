 ...
 * 
 * <p>
 * This class is responsible for populating chests with randomized loot
 ...
 * distribution of items across the arena.
 * </p>
 * 
 * <p>
 * The ChestManager loads loot configurations from files and provides
 * methods to fill chests with appropriate loot based on their tier and
 * the current game state.
 * </p>
 * 
 * <p>
 * Thread-safe implementation using ThreadLocalRandom and proper
 * synchronization.
 * </p>
 * 
 * @author LumaLyte
...
public class ChestManager {
    ...
    public void start() {
        // Load chest items
        loadChestItems().thenRun(() -> logger.info("Loaded " + chestItems.size() + " chest items."));
    }
    ...
    /**
     * Loads a single item from the configuration and adds it to the chest items
     * list.
     * 
     ...
     * 
     * <p>
     * This method determines the appropriate loot tier for the chest
     * and populates it with random items from that tier's loot table.
     * The chest is completely cleared before being filled with new loot.
     * </p>
     * 
        ...
        while (filledSlots < itemCount && attempts < maxAttempts) {
            ...
            if (selectedItem.getMaxAmount() > selectedItem.getMinAmount()) {
                amount += ThreadLocalRandom.current()
                        .nextInt(selectedItem.getMaxAmount() - selectedItem.getMinAmount() + 1);
            }
     ...
     *
     * <p>
     * This method randomly selects a loot tier and fills the chest with
     ...
     * 
     * <p>
     * This method returns all chest items that belong to the specified tier.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method uses the chance/rarity system to select items. Items
     * with higher chances have a greater probability of being selected.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method returns an unmodifiable view of the internal chest items list
     * to prevent external modification of the collection.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method scans all loaded chest items and extracts the unique
     * tier names, providing a complete set of available tiers.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method filters the loaded chest items by the specified tier
