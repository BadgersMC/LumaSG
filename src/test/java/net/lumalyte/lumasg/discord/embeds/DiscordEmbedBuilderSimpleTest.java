...
/**
 * Simple unit tests for DiscordEmbedBuilder focusing on core functionality.
 */
@ExtendWith(MockitoExtension.class)
class DiscordEmbedBuilderSimpleTest {
    ...
    void setUp() {
        ...
        when(game.getPlayers()).thenReturn(Set.of(UUID.randomUUID(), UUID.randomUUID()));
